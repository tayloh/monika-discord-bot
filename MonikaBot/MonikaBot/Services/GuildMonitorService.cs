...
namespace MonikaBot
{
    class GuildMonitorService
    {
        ...
        private async Task client_UserJoinedAsync(SocketGuildUser guildUser)
        {
            ...
            await guildUser.Guild.DefaultChannel.SendMessageAsync(guildUser.Mention + " Joined the server. " + messages[_random.Next(0, 4)]);
        ...
        private async Task client_UserBannedAsync(SocketUser user, SocketGuild guild)
        {
            ...
            await guild.DefaultChannel.SendMessageAsync(user.Mention + " Was banned. " + messages[_random.Next(0, 2)]);
        }
